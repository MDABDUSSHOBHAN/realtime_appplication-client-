...
const Avatar = () => {
    ...
    useEffect(() => {
        ...
        try {
          ...
          while (retries < maxRetries) {
            try {
              ...
              newData.push(base64Image);
              // Successfully fetched an image, break out of retry loop
              break;
            } catch (error) {
              if (error.response && error.response.status === 429) {
                ...
                retries++; // Increase retries even for non-429 errors to retry up to maxRetries
              }
            }
          }
      ...
      fetchData();
    }, []); // Empty dependency array ensures useEffect runs only once on mo
